...
class MultiDayViewConfiguration extends ViewConfiguration {
  ...
  ///
  /// When [Axis.vertical] (default), time flows top-to-bottom and days spread left-to-right.
  /// When [Axis.horizontal], time flows left-to-right and days spread top-to-bottom.
  ...
  MultiDayViewConfiguration copyWith({
    ...
    final orientation0 = orientation ?? this.orientation;
