...
class _TimeIndicatorState extends State<TimeIndicator> {
  ...
  Widget build(BuildContext context) {
    ...
    final position = now.difference(startTime).inMinutes * widget.heightPerMinute;
    ...
    if (isHorizontal) {
      // Vertical line at the current time position on the horizontal time axis.
      return IgnorePointer(
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              left: position - circleWidth / 2,
              top: -(circleHeight / 2) + _circleCenterOffset,
              width: circleWidth,
              height: circleHeight,
              child: DecoratedBox(
      ...
      // Horizontal line at the current time position on the vertical time axis (default).
      return IgnorePointer(
        child: Stack(
          clipBehavior: Clip.none,
          children: [
