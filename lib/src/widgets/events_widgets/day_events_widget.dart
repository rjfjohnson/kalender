...
class MultiDayEventsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // When horizontal, days stack vertically (Column). When vertical, days spread horizontally (Row).
    return isHorizontal ? Column(children: children) : Row(children: children);
  }
}
...
class _DayEventsColumnState extends State<DayEventsColumn> {
  ...
  Widget build(BuildContext context) {
    ...
    final isHorizontal = widget.viewConfiguration.isHorizontal;
    final orientation = widget.viewConfiguration.orientation;

    final layoutStrategy = widget.configuration.eventLayoutStrategy;
    final delegate = layoutStrategy.call(
      _events,
      widget.date,
    ...
    // Set orientation on the delegate.
          ...
          .map(
            (item) => LayoutId(
              ...
              child: DayEventTile(
                ...
                resizeAxis: isHorizontal ? Axis.horizontal : Axis.vertical,
              ),
            ),
          )
          .toList(),
...
class _DayDropTargetColumnState extends State<DayDropTargetColumn> {
  ...
  Widget build(BuildContext context) {
    ...
    final dropDelegate = layoutStrategy.call(
      eventList,
      widget.date,
      widget.viewConfiguration.timeOfDayRange,
      context.heightPerMinute,
    ...
    dropDelegate.orientation = widget.viewConfiguration.orientation;
